...
class HistoryItemViewAdapter(val context: Context, private val clickView : ListItemViewAdapter.onClick, private val callback : ItemListCallback?=null ) :
    RecyclerView.Adapter<HistoryItemViewAdapter.ViewHolder>() {
    ...
    interface ItemListCallback {
        fun onItemListUpdated(list: List<Item>)
    }
    ...
    fun submitList(newList: List<Item>) {
        ...
        callback?.onItemListUpdated(item)
    }
